...
6. Add new property inside a function
   ...
   Finally, invoke your new function while passing in the `plainPerson` object and additional argument values, then store
...
console.log(buildPerson(plainPerson, "tom", 21));
console.log(buildPerson(plainPerson1, "Phil", 6));
console.log(buildPerson(plainPerson2, "Steve", 50));
